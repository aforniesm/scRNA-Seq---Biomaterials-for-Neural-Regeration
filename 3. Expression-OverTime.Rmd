...
results4 <- results3 %>%
  filter(Gene %in% c("Lgi2", "Lamb2", "Lama5", "Cbln1", "Cxcl12", "Plxnb1"))

results3 <-  results3 %>% 
  filter(!(Gene %in% c("Cbln1", "Lamb2", "Lama5", "Lgi2", "Plxnb1", "Cxcl12")))
...
celltype_chronic <- read_excel("~/R/Data/DEG_Celltype_Chronic.xlsx")
