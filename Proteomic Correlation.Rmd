...
transcriptomic <- transcriptomic %>% filter(abs(transcriptomic$avg_log2FC) > 0.75)
transcriptomic <- transcriptomic$Gene

proteomic <- proteomic %>% filter(expr_Adjpval_Acute_Ctrl == "up" | expr_Adjpval_Acute_Ctrl == "down" )
...
ggsave("~/R/Figures/Proteomic_Venn_Acute (7 dpi).png", venn_diagram, dpi = 1080, height = 7, width = 9)
...
proteomic <- proteomic %>% filter(expr_Adjpval_Chronic_Ctrl == "up" | expr_Adjpval_Chronic_Ctrl == "down" )
proteomic <- proteomic$Gene
...
ggsave("~/R/Figures/Proteomic_Venn_Sub-Chronic (4-6 wpi).png", venn_diagram, dpi = 1080, height = 7, width = 9)
